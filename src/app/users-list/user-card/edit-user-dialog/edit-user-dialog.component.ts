...
@Component({
  ...
  standalone: true,
  imports: [NgIf, MatButtonModule, MatCardModule, MatDialogClose, ReactiveFormsModule, MatFormFieldModule, MatInputModule],
...
export class EditUserDialogComponent {
  ...
  public form = this.fb.group({
    name: this.fb.control(this.data.user.name, [Validators.required, Validators.minLength(3)]),
